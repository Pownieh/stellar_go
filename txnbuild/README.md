...
### Installing
* `go get github.com/pownieh/stellar_go/txnbuild`
...
* Enter the demo directory: `cd $GOPATH/src/github.com/pownieh/stellar_go/txnbuild/cmd/demo`
