...
programmers is horizonclient (https://github.com/pownieh/stellar_go/tree/master/clients/horizonclient). Together, these two
libraries provide a complete Stellar SDK.
For more information and further examples, see https://github.com/pownieh/stellar_go/blob/master/docs/reference/readme.md
*/
package txnbuild
