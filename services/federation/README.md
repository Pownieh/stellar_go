...
[Prebuilt binaries](https://github.com/pownieh/stellar_go/releases) of the federation server are available on the [releases page](https://github.com/pownieh/stellar_go/releases).
...
```
go get -u github.com/pownieh/stellar_go/services/federation
```
